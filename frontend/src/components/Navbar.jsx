        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            <div className={`flex items-center gap-1 px-1 py-1 rounded-xl ${
              ...
              <NavLink to="/how-it-works" icon={HowItWorksIcon} isActive={isActive('/how-it-works')} isDark={isDark}>
            ...
            {user ? (
              <div className="space-y-2">
                ...
                <div className="space-y-1 px-1">
                  ...
                  <NavLink to="/how-it-works" icon={HowItWorksIcon} isActive={isActive('/how-it-works')} isDark={isDark} onClick={closeMobileMenu}>
                    {t('navbar.how_it_works')}
                  </NavLink>
                </div>
